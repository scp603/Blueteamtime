#!/usr/bin/env bash
# =============================================================================
# triage-ubuntu.sh — Nine-Tailed Fox CDT Competition
# Ubuntu monitoring & auditing setup
...
if [[ -f "$SCRIPT_DIR/audit.rules" ]]; then
    ...
    warn "audit.rules not found next to triage-ubuntu.sh — skipping rule deploy"
fi
